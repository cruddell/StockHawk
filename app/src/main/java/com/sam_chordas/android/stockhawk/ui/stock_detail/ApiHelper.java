...
import com.sam_chordas.android.stockhawk.utils.MiscUtils;
...
public class ApiHelper {
    ...
    /**
     * Retrieves details for a stock symbol
     * @param symbol -- the symbol of the stock to retrieve details for in a background thread
     * @param callback -- implementation of the NetworkCallback interface used to retrieve the results
     * @param context -- any valid context - will be used to return results back on main thread
     */
    public static void getStockDetails(String symbol, final NetworkCallback callback, final Context context) {
        String url = UrlBuilder.detailStockUrl(symbol);
    ...
    /**
     * Make HTTP request
     * Note: Yahoo Developer Network apis require OAUTH authentication.
     * TODO: Research http://stackoverflow.com/questions/24278942/use-oauth-to-call-yahoo-api-in-android for guidance on implementing.
